...
IUSE="
	...
	startup-notification xft unicode3 +vanilla wcwidth hime-protocol
"
...
src_prepare() {
	...
	epatch \
        ...
        use hime-protocol && epatch "${FILESDIR}"/${PN}-9.18-hime-protocol.diff
...
src_configure() {
	...
	econf --enable-everything \
		...
		$(use_enable xft) \
		$(use_enable unicode3) \
                $(use hime-protocol && echo --disable-xim) \
		${myconf}
}
