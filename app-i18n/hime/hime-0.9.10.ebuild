...
SRC_URI="http://hime.luna.com.tw/${P}.tar.xz
	chinese-sound? ( http://www.csie.nctu.edu.tw/~cp76/hime/download/ogg.tgz )"

LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE="filter-nobopomofo chinese-sound anthy chewing gtk3 qt4 array30+colemak"
...
src_prepare() {
	use array30+colemak && cp -f "${FILESDIR}/ar30"{,-big}.cin "${S}/data/"
